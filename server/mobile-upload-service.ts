...
function mobilePage(locale: MobilePageLocale): string {
  ...
  const copy = {
    en: {
      pageTitle: 'Upload from phone', title: 'Send media to Aquarius Editor',
    ...
    ru: {
      pageTitle: 'Загрузка с телефона', title: 'Отправить медиафайлы в Aquarius Editor',
...
<title>Aquarius Editor · ${copy.pageTitle}</title><style>
