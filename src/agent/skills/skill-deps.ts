...
// name services Aquarius Editor does not expose the same way. This module scans a
  ...
  for (const dep of deps) {
    ...
    if (dep.kind === 'runtime') {
      lines.push(
        ...
        + 'You are the Aquarius Editor built-in agent: run the same deterministic steps with THIS environment\'s tools '
