  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'MiniMax HTTP streaming transport. Aquarius Editor consumes it server-side and saves one durable audio asset.' },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'Mureka only. Enable provider streaming phase; Aquarius Editor still saves durable final files.' },
