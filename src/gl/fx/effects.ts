...
export const FX_EFFECTS: Record<string, FxDef> = {
  ...
  'builtin:fx-color-wheels': {
    ...
    desc: 'Colorist-style three-way color wheels: lift shifts the shadows, gamma the midtones, gain the highlights — all neutral at 0.5 gray, applied per channel.',
  ...
  'builtin:fx-levels': {
    ...
    name: 'Levels',
    desc: 'Remaps the input black/white points + midtone gamma + output black/white points (per channel); pair with inspect_color\'s black/white point readout.',
    frag: levelsFrag,
    props: [
  ...
  'builtin:fx-highlights-shadows': {
    ...
    desc: 'Adjusts shadows and highlights independently via a soft luminance mask: brighten shadows (protecting highlights), recover or boost highlights.',
  ...
  'builtin:fx-clarity': {
    ...
    name: 'Clarity',
    desc: 'Local midtone contrast (luminance unsharp mask): positive values add texture, negative values soften skin.',
    frag: clarityFrag,
    props: [
  ...
  'builtin:fx-hsl-qualify': {
    ...
    name: 'HSL Qualifier',
    desc: 'Secondary color correction: shifts hue/saturation/luma only within a selected hue range (center ± width + feather); targets skin tones, sky, or brand colors.',
    frag: hslQualifyFrag,
    props: [
      ...
      { key: 'lumaMul', label: 'Luma ×', default: 1, min: 0.5, max: 1.5, step: 0.01 },
    ],
  },
