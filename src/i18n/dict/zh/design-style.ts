// ZH dictionary: Chinese names, style guides and colour/font role labels for the built-in
// design-style presets. The English strings in src/editor/design-presets.ts are the source
// language; this table is their Chinese translation, so it lives with the other zh dictionaries.

export const PRESET_NAME_ZH: Record<string, string> = {
...
export const PRESET_GUIDE_ZH: Record<string, string> = {
...
export const FONT_ROLE_ZH: Record<string, string> = {
  ...ROLE_ZH,
  accent: '强调字体',
  callout: '标注字体',
  impact: '冲击字体',
