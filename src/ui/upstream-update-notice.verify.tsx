...
const markup = renderToStaticMarkup(
  <div data-dashboard-chrome>
    <UpstreamUpdateNoticeView
      message="A new version of OpenChatCut is available: V0.2.0 (you're on V0.1.9). You can download and install it now."
...
assert.match(markup, /A new version of OpenChatCut is available: V0\.2\.0/, 'the update notice must clearly state the official product and version');
